...
public class ProjectManagementApplication {
    ...
    //We are currently using SQL file data.sql for populating database.
    /*
    We have to name file that populates tables "data.sql" and file that creates schema (if we dont want JPA to do it
    automatically) "schema.sql". Those are loaded automatically by spring and therefore must be placed into "/resources/" folder.
    To tell spring that we want to use our schema file we have to add a property into application.properties file:
